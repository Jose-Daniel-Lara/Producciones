  ...
  <div class="card mt-4 mb-4 justify-content-center shadow ">
           <div class="card-header card-footer d-grid gap-2 d-md-flex">
                ...
                <div class="d-grid gap-3 d-flex justify-content-md-end justify-content-center col-md-3 text-end">
                 ...
                 <button class="btn12 fw-bold col-3 col-lg-2" type="button" data-bs-toggle="modal" data-bs-target="#exampleRegistrarC"style="box-shadow:none!important;" data-bs-toggle="tooltip" data-bs-placement="top" title="Registrar Mesa" ><i class="bx bxs-edit " style="font-size: 23px!important;"  ></i></button>
                 ...
                 <a href="?url=reporteClientes" class=" btn11 fw-bold col-3 col-lg-2 text-center pt-1 " type="button" style="box-shadow:none!important;"  data-bs-toggle="tooltip" data-bs-placement="top" title="Reporte de Clientes"><i class="bi bi-upload" style="font-size: 23px!important;"  ></i></a>
                  ...
                  <a class=" fw-bold col-3 col-lg-2 text-center mt-1 " type="button" data-bs-toggle="modal" data-bs-target="#papeleraCL" data-bs-toggle="tooltip" data-bs-placement="top" title="Papelera Mesa"><i class="bi bi-trash icon999 " style="color: #fff; font-size: 30px;" ></i></a>
                   ...
                   ?>
                    ...
                    <th class="text-left"><?php echo $data->correoElectronico  ?></th> 
                     ...
                     <th class="text-center d-grid gap-2 d-flex justify-content-lg-center" >
                        <button class="btn btn90 fw-bold  mb-1 col-6 col-md-4" type="button" data-bs-toggle="modal" data-bs-target="#exampleModificarC<?php echo $data->cedula ?>" ><i class="bi bi-pencil-fill "></i></button>
                        <button class="btn btn11 fw-bold  mb-1 col-6 col-md-4" type="button" data-bs-toggle="modal" data-bs-target="#exampleEliminarC<?php echo $data->cedula ?>" ><i class="bi bi-trash-fill "></i></button>
                    </th>
          ...
          <div class=" row g-2 ">
            ...
            <div class="col-6" >
              ...
              <div class="row inputV">
                ...
                <div class="col-md-6 tel1 "  style="display: none;">
                    <label  class="form-label"><i class="ri-phone-fill icon"  style="color: #c79b2d!important;"></i>Telefono</label>
                   
                     <input type="number" class="form-control" value="<?php echo $data->telefono ?>" placeholder="N° Telefono" name="tel00" id="telefono">
                     <p id="errorTelefono"  class=" text-center l"></p>
                
                </div>

                 <div class="col-md-6 email1"  style="display: none;">
                    <label class="form-label"><i class="bi bi-envelope-fill icon " style="color: #c79b2d!important;"></i>Correo Electrónico</label>

                     <input type="text" class="form-control"  value="<?php echo $data->correoElectronico ?>" placeholder="Correo Electrónico" name="corr00" id="correo">
                     <p id="errorCorreo"  class=" text-center l"></p>
         ...
         <div class="table-responsive bordered ">
                ...
                <tbody">
                  <?php
                    ...
                    foreach ($papeleraClientes as $data){
